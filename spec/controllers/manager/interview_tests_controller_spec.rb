    ...
    context 'with search parameters' do
      let!(:google_test) do
        create(:interview_test, company: 'Google').tap do |test|
          create(:interview_question, description: 'Technical',
                                      interview_test: test)
        end
      end
      ...
      let!(:microsoft_test) do
        create(:interview_test, company: 'Microsoft').tap do |test|
          create(:interview_question, description: 'Behavioral',
                                      interview_test: test)
        end
      end
      ...
      it 'assigns @interview_tests based on search by company' do
        get :index, params: { q: {
          company_or_interview_questions_description_cont: 'Google'
        } }
      ...
      it 'assigns @interview_tests based on search by description' do
        get :index, params: { q: {
          company_or_interview_questions_description_cont: 'behavioral'
        } }
